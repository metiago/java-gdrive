...
interface FileEndpointInterface {
    ...
    @ApiResponses(value = {@ApiResponse(code = 204, message = "No content"),
            @ApiResponse(code = 401, message = "Unauthorized")})
    ResponseEntity<Void> delete(@ApiParam(value = "id of a existing file") String id) throws Exception;


    @ApiOperation(value = "Empty drive's trash")
    @ApiResponses(value = {@ApiResponse(code = 204, message = "No content"),
                           @ApiResponse(code = 401, message = "Unauthorized")})
    ResponseEntity<Void> emptyTrash() throws Exception;
